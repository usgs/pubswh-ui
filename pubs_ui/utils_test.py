...
expected_output = r'<html><body><div class="feed"><div style="border-top: 1px solid #ddd; border-bottom: 1px solid #ddd; padding: 10px;"><h4 id="OtherResources-Ordering:">Ordering:</h4><p> All this test text </p></div></div></body></html>'
output = utils.pull_feed("http://test_url/test")

print unittest.assertEqual(expected_output, output)
