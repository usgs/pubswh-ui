...
def make_json(step):
    ...
    world.expected_output = {
        'geographicExtents': {
            u'features': [{
                u'geometry': {
                    u'coordinates': [[[-72.745833, 44.0625],
...
def search_pubs(step):
    ...
    world.expected_return_content = {
        ...
        u'recordCount': 1776,
        u'records': [{
            'authorsList': [u'Eve L. Kuniansky'],
            'authorsListTyped': [{
                'email': u'elkunian@usgs.gov',
    ...
    world.munged_abstract_result_expected = {
        ...
        u'contributors': {
            u'authors': [{
                ...
                u'contributorId': 131090,
                u'contributorType': {u'id': 1, u'text': u'Authors'},
                u'corporation': False,
                u'email': u'evarela-acevedo@usgs.gov',
                u'family': u'Varela Minder',
                u'given': u'Elda',
